...
public class ModItems {
    ...
    //Exotics
    public static final Item EXOTIC_MATTER = registerItem("exotic_matter", new Item(new FabricItemSettings().group(ItemGroup.MISC).fireproof().rarity(Rarity.RARE).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.2f).snack().alwaysEdible().build())));
