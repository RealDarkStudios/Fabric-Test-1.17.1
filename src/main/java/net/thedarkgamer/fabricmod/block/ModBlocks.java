...
import net.thedarkgamer.fabricmod.block.custom.*;
...
public class ModBlocks {
    ...
    public static final Block OVERWORLD_EXOTIC_BUTTON = registerBlock("overworld_exotic_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.METAL).hardness(4).strength(3).requiresTool().noCollision()), new FabricItemSettings().rarity(Rarity.RARE).fireproof().group(ModItemGroups.BLOCKS));
